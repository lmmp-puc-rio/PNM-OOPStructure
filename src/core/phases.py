...
class Phases:
    ...
    def update_geometry_model(self):
        ...
        self.config_general.cross_sec = CrossSecType.TRIANGULAR 
        self.add_hydraulic_conductance_model(self.get_wetting_phase()["model"])
        self.add_hydraulic_conductance_model(self.get_non_wetting_phase()["model"])
        self._update_hydraulic_conductance_nwp()
        self.get_wetting_phase()["model"].regenerate_models()
        self.get_non_wetting_phase()["model"].regenerate_models()
        print("aqui foi")
